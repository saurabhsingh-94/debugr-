...
import { CheckCircle2, Package, ArrowRight, ShieldCheck, ExternalLink, Loader2 } from 'lucide-react';
      ...
      <main className="relative z-10 pt-48 pb-32 px-6 flex flex-col items-center justify-center min-h-[80vh]">
        <Suspense fallback={
          <div className="flex flex-col items-center gap-6">
            <Loader2 className="w-16 h-16 text-amber-500 animate-spin" />
            <p className="text-[10px] font-black uppercase tracking-[0.6em] text-white/20">Inhibiting Protocol...</p>
          </div>
        }>
          <SuccessContent />
        </Suspense>
